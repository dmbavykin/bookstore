...
ActiveRecord::Schema.define(version: 20180410125251) do
  ...
  create_table "shoppy_cartus_addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["addressable_type", "addressable_id"], name: "index_sh_cart_addresses_on_addressable_type_and_addressable_id"
  end
